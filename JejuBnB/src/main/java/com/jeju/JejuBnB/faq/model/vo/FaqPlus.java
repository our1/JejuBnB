...
public class FaqPlus implements java.io.Serializable {
	...
	public FaqPlus(int faq_no, String faq_title, String faq_rcontent, int faqcategory_no, String faqcategory_name) {
		super();
		this.faq_no = faq_no;
	...
	public String toString() {
		return "FaqPlus [faq_no=" + faq_no + ", faq_title=" + faq_title + ", faq_rcontent=" + faq_rcontent
				+ ", faqcategory_no=" + faqcategory_no + ", faqcategory_name=" + faqcategory_name + "]";
	}
