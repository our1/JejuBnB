            ...
            <header class="main-header dark-header fs-header sticky">
                <div class="header-inner">
                    <div class="logo-holder">
                        <a href="index.html"><img src="resources/resources/images/logo.png" alt=""></a>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="footer-widget fl-wrap">
                                ...
                                <div class="widget-posts fl-wrap">
                                    <ul>
                                        <li class="clearfix">
                                            <a href="#"  class="widget-posts-img"><img src="resources/resources/images/all/1.jpg" class="respimg" alt=""></a>
