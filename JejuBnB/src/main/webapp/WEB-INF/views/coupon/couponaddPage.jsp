                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="profile-edit-container add-list-container">
                                            ...
                                            <div class="custom-form" >
                                                <label>쿠폰 금액<i class="fa fa-briefcase"></i></label> <input type="number"
												placeholder="금액" name="coupon_money" required
                                        ...
                                        <div class="profile-edit-container add-list-container">
                                            ...
                                            <div class="custom-form">                                                
                                                <label>시작날짜<i class="fa fa-calendar"></i></label>
											<input type="date" name="coupon_begin" max="99-12-31" id="begin">
											<br>
											   <label>끝날짜<i class="fa fa-calendar"></i></label>
											<input type="date" name="coupon_end" max="99-12-31" id="end">
										</div>
                                        </div>
                                        <!-- profile-edit-container end-->                                                                                                                                                                                                      
