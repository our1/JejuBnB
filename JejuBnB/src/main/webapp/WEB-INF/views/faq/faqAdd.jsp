                        ...
                        <div class="container">
							...
							<div class="profile-edit-page-header">
								...
								<div class="breadcrumbs">
									<a href="main.do">Home</a><a href="faqTop7.do">고객센터</a><span>자주묻는질문(FAQ)</span>
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="profile-edit-container add-list-container">                                           
                                           <div class="custom-form" >
                                                <label>자주 묻는 질문 유형<i class="fa fa-briefcase"></i></label> <select  id="faqcategory_no" name="faqcategory_no"
                                            ...
                                            <div class="custom-form">                                                
                                                <label>질문<i class="fa fa-calendar"></i></label>
											 <input type="text"  placeholder="질문을 입력하세요." name="faq_title" required
											 style="float: left; border: 1px solid #eee; background: #f9f9f9; width: 100%; padding: 15px 20px 15px 55px; border-radius: 6px; color: #666; font-size: 13px;"> 
										</div>
										 <div class="custom-form">
                                                <label>답변</label>
                                                <textarea cols="40" rows="3" placeholder="답변을 입력하세요.." name="faq_rcontent"></textarea>
