...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="main.do">
        ...
        <div class="sidebar-brand-text mx-3">JejuBnB</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">사장님 신청 리스트</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          ...
          <span>JejuBnB 관리</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="moveFilterList.do">숙소 검색 필터 관리</a>
            <a class="collapse-item" href="utilities-border.html">예약 관리</a>
            <a class="collapse-item" href="utilities-animation.html">고객센터 관리</a>
            <a class="collapse-item" href="utilities-other.html">FAQ 관리</a>
          </div>
        </div>
      </li>
  ...
  <!-- Page level plugins -->
  <script src="resources/css/vendor/chart.js/Chart.min.js"></script>
