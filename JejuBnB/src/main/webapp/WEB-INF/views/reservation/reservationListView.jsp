...
#pos6:checked ~.pos>label:nth-child(6) {
	...
	<table>	
		...
		<input type="hidden" name="reply_no" value="${review.reply_no}">
			...
			<form action="rreinsert.do" method="post">
			<input type="hidden" name="room_no" value="${room.room_no}">
			<input type="hidden" name="reply_no" value="${review.reply_no}">
			<c:if test="${ loginMember.user_id eq room.user_id and loginMember.user_id ne review.user_id}">
			<tr>
				<td>${review.user_id} </td> 
				<td><fmt:formatDate value="${review.review_date}" pattern="yyyy-MM-dd" /> </td>
				<td>${review.review_content}</td>
			...
			<tr>
				<%-- <td>${ room.user_id }님의 답변</td>
				<td><textarea rows="2.2" cols="36" name="review_content"></textarea></td> --%>
				<td><span class="writeReReply"><a href="#" id="rreply">답변하기</a></span></td>
			</tr>
			</c:if>
			</form>
		</c:forEach>
				...
				<div class="dropdown-content_1">
					<div class="number">
						...
						<input type="hidden" name="room_weekend" value="${ room.room_weekend }">
							<h4>성인</h4>
							<span><button id="decreaseQuantity" class="btn_increaseQuantity" data-type="1">&#8722;</button></span> 
							<span id="numberUpDown">1</span> 
						    <span><button id="increaseQuantity" class="btn_increaseQuantity" data-type="1">&#43;</button></span>
							<h4>어린이</h4>
							<span><button id="decreaseQuantity2" class="btn_increaseQuantity" data-type="2">&#8722;</button></span> 
							<span id="numberUpDown2">0</span> 
							<span><button id="increaseQuantity2" class="btn_increaseQuantity" data-type="2">&#43;</button></span>
							<h4>유아</h4>
							<span><button id="decreaseQuantity3" class="btn_increaseQuantity" data-type="3">&#8722;</button></span>
							<span id="numberUpDown3">0</span> 
							<span><button id="increaseQuantity3" class="btn_increaseQuantity" data-type="3">&#43;</button></span>
