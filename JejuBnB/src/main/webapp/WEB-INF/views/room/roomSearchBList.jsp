                                ...
                                <div class="list-main-wrap fl-wrap card-listing">
                                    ...
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                        	<c:forEach items="${rflist }" var="rf">
												 ...
												 <div class="swiper-button-prev sw-btn" onclick="plusSlides(1,${room.room_no})" style="left:0;top:250px;"><i class="fa fa-long-arrow-left"></i></div>
                                    ...
                                    <div class="pagination">
	                                        ...
	                                        <c:if test="${currentPage ne 1 }">
	                                        	<a href="moveRoomBList.do?page=${currentPage -1 }" class="prevposts-link"><i class="fa fa-caret-left"></i></a>                                        
	                                        </c:if>
	                                   		<c:forEach var="count" begin="1" end="5" step="1">
		                                    	...
		                                    	<c:if test="${currentPage ne count }">
		                                    		 <a href="moveRoomBList.do?page=${count}" class="blog-page transition">${count }</a>
		                                    	</c:if>
	                                  		</c:forEach>
	                                  		...
	                                  		<c:if test="${currentPage ne endPage }">
                                      			<a href="moveRoomBList.do?page=${currentPage +1 }" class="nextposts-link"><i class="fa fa-caret-right"></i></a>	                                 	 		
	                                  		</c:if>
                                    </div>
                                </div>
                                <!-- list-main-wrap end-->                           
